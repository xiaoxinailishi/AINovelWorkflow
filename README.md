...
> 使用了 **100 亿 Token**，写出了 **300 万字废稿**与 **80 万字正文**，在一次次推翻、重写、复读和验收中逐步推进，总算练成了这套长篇小说自动审核与编写流程。
...
- 同层互证：[通用资产清单](00_模板库入口/08_通用资产清单.md)、[完整资产登记与缺口清单](00_模板库入口/09_完整资产登记与缺口清单.md)。
