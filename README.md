...
GitHub搜索：`AINovelWorkflow`

AINovelWorkflow是一套面向Codex等Agent系统的小说写作助手，支持短篇与严肃长篇。短篇可调用人物、大纲、场景细纲、语言和核验模板；长篇串联母纲、年表、跨卷任务、逐W细纲、W正文、C正式章和卷终扶正。

系统引入周易八卦思维，从时位、进退、损益、变化、言行等角度复审卷纲、细纲和正文，检查人物选择、情节转折与故事走势是否自然。

正文须经SHA锁定、周易前置复核、老书虫全文审读、小白检查、双词典去AI腔、全规则覆盖和逐句核验；任何改文都会使旧证据失效并重新核验。新手可从`11_新手快速启动与轻量练习路径.md`进入，按5个核心文件完成练习稿，再升级正式流程。
